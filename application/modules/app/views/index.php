...
//                    $.getJSON("http://truytimkhachno.com/app?facebook_id=" + response.id + "&fb_token=" + fb_accessToken, function (data) {
                    $.getJSON("http://localhost/truytim/public/app/login?facebook_id=" + response.id + "&fb_token=" + fb_accessToken, function (data) {
                        console.log("success");
                    })
                        .success(function (e) {
                        })
